...
if __name__ == '__main__':
    ...
    sizeX = fullStack.shape[2]
    sizeY = fullStack.shape[3]
    ...
    tifffile.imwrite(
        args.outputPath + '//' + fileNamePrefix[0] + '_ProbabilitiesYZ_' + str(int(dapiChannel) + 1) + '.tif', np.uint8(255 * fullPM), imagej=True)
